...
class Prime {
    ...
    public function calculatePrimeMonth() : void
    {
        ...
        foreach($listAtteinteMois as $atteinteAgentByCritere)
        {
            ...
            if($calculprimeAction){
                ...
                var_dump($currentBaseMensuelle, $newBaseMensuelle, $tempLoopData);
            } 
    ...
    public function calculatePrimeReachDay() : void
    {
        ...
        $listDataProductionDay = $this->CI->primeproduction_model->getDataProductionMcpByDate($currentDate);
        //var_dump($listDataProductionDay); die;
