<div class="row">
    <div class="row">
        <div class="col-md-12  title-page">
            <h2>Suivi pointage des agents de transport</h2>
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <table id="poinatge-transport" class="table-striped table-hover" style="width:100%">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>Site</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        dom: 'Blfrtip',
            ...
            ajax : "<?= site_url("pointage/getPointageTransport"); ?>",
            columns : [
                { data : 'date'},
                { data : 'site_libelle'},
                { data : 'usr_prenom'},
