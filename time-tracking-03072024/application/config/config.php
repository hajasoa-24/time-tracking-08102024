...
|
*/
//$config['base_url'] = 'http://localhost/time-tracking-preprod/';
//$config['base_url'] = 'http://192.168.0.247/time-tracking/';
...
|
*/
$config['encryption_key'] = 'helloTimeTrackingApp';
...
$config['sess_cookie_name'] = 'ci_session_timetracking';
