...
class Prime_model extends CI_Model {
    ...
    {
        $this->db->select('prime_id, prime_user, prime_mois, prime_annee, prime_datecrea, prime_datemodif')
    ...
    {
        if($this->getPrimeById($id) !== FALSE) return true;
        return false;
    }
