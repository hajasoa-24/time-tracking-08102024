				...
				<div class="modal-body">
					<div class="row container">
						<div class="col-md-12">
							...
							<div class="row critere critere-base-prime">
								<div class="col-sm-3">
...
<div class="modal fade" id="modaladdobjectifjournalier" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modaladdobjectifjournalier" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form id="formaddobjectifjournalier" method="post" action="<?= site_url('primecritere/insertobjectifjournalier') ?>">
				<div class="modal-header">
					<h5 class="modal-title">Ajout d'un objectif journalier</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<div class="row form-group">
								...
								<div class="col-sm-9">
									<input type="text" readonly id="objectifjournalier_criterelibelle" class="form-control">
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="col-sm-9">
									<input type="text" readonly id="objectifjournalier_criterecampagne" class="form-control">
								</div>
							</div>
							...
							<div>
								<div class ="row form-group">
									...
									<div class = "col-sm-9">
										<input type="text" readonly id="objectifjournalier_criteretype" class="form-control">
									</div>
								</div>
							...
							<div class="row form-group">
								...
								<div class = "col-sm-9">
									<input type="text" readonly id="objectifjournalier_critereprofil" class="form-control">
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class = "col-sm-9">
									<input type="text" readonly id="objectifjournalier_critereprocess" class="form-control">
								</div>
							</div>

							<div class="row form-group">
								<div class="col-sm-3">
									<label for="prime_modedecalcul">Date:</label>
								</div>
								
								<div class="col-sm-9">
									<input type="text" readonly id="objectifjournalier_day" name="objectifjournalier_day" class="form-control" value="<?= $day ?>">
								</div>
							...
							<div class="row form-group">
								<div class="col-sm-3">
									<label for="prime_modedecalcul">Objectif:</label>
								</div>
								
								<div class="col-sm-9">
									<input type="text" id="objectifjournalier_objectif" name="objectifjournalier_objectif" class="form-control">
								</div>

							</div>

							<input type="hidden" id="objectifjournalier_critere" name="objectifjournalier_critere">
...
<script type="text/javascript">
    $(document).ready(function()
    {
...

		{
			...
			columns: [
				...
				{data :"primecritere_objectif"},
				{
					...
					{
						let dayObjectif = '<button title="Definir objectif" data-critere="'+data.primecritere_id+'" data-criterelib="'+data.primecritere_libelle+'" data-criterecampagne="'+data.campagne_libelle+'" data-critereprofil="'+data.primeprofil_libelle+'" data-criteretype="'+data.primetypecritere_libelle+'" data-critereprocess="'+data.process_libelle+'" class="add_objectif_journalier btn btn-warning btn-sm mr-1"><i class="fa fa-calendar-plus-o"></i></button>';
						if(data.primeobjectifjour_valeur != null){
							dayObjectif = data.primeobjectifjour_valeur + '<button title="Definir objectif" data-objectif="'+data.primeobjectifjour_valeur+'" data-critere="'+data.primecritere_id+'" data-criterelib="'+data.primecritere_libelle+'" data-criterecampagne="'+data.campagne_libelle+'" data-critereprofil="'+data.primeprofil_libelle+'" data-criteretype="'+data.primetypecritere_libelle+'" data-critereprocess="'+data.process_libelle+'" class="add_objectif_journalier btn btn-info btn-sm ml-1"> <i class="fa fa-edit"></i></button>'
						}
		...
		$(document).on('change', '#TypeCritere', function(){
			$(".critere").hide();
			let toClass = $('#TypeCritere option:selected').text().split(" ").join("-").toLowerCase();
			$(".critere-"+toClass).show();
		})
		...
		$(document).on("change", "#campagneflitre", function (){
			...
			TableCritere.ajax.url('<?= site_url('primecritere/getprimeallcritere/') ?>' + id_filter).load();
		...
		$(document).on('click', '.add_objectif_journalier', function(){

			$('#objectifjournalier_critere').val('');
			$('#objectifjournalier_criterelibelle').val('');
			$('#objectifjournalier_criterecampagne').val('');
			$('#objectifjournalier_criteretype').val('');
			$('#objectifjournalier_critereprofil').val('');
			$('#objectifjournalier_critereprocess').val('');

			let critereId = $(this).data('critere');
			let campagne = $(this).data('criterecampagne');
			let type = $(this).data('criteretype');
			let profil = $(this).data('critereprofil');
			let process = $(this).data('critereprocess');
			let lib = $(this).data('criterelib');
			let objectif = $(this).data('objectif');

			$('#objectifjournalier_critere').val(critereId);
			$('#objectifjournalier_criterelibelle').val(lib);
			$('#objectifjournalier_criterecampagne').val(campagne);
			$('#objectifjournalier_criteretype').val(type);
			$('#objectifjournalier_critereprofil').val(profil);
			$('#objectifjournalier_critereprocess').val(process);
			$('#objectifjournalier_objectif').val(objectif);
			$('#modaladdobjectifjournalier').modal('show');
		})
