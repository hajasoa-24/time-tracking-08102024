<div class="row">
    <div class="row">
        <div class="col-md-12  title-page">
            <h2>Suivi pointage des agents de sécurité</h2>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <table id="pointage-securite" class="table-striped table-hover" style="width:100%">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>Site</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        dom: 'Blfrtip',
            ...
            ajax : "<?= site_url("pointage/getPointageSecurite"); ?>",
            columns : [
                { data : 'date'},
                { data : 'site_libelle'},
                { data : 'usr_prenom'},
