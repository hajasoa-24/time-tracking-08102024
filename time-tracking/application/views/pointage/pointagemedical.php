<div class="row">
    <div class="row">
        <div class="col-md-12  title-page">
            <h2>Suivi pointage des médecins</h2>
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <table id="pointage-medical" class="table-striped table-hover" style="width:100%">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>Site</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        dom: 'Blfrtip',
            ...
            ajax : "<?= site_url("pointage/getPointageMedical"); ?>",
            columns : [
                { data : 'date'},
                { data : 'site_libelle'},
                { data : 'usr_prenom'},
